...
<form action="/action_page.php">
  <div class="container">
    ...
    <label for="Phone"><b>Mobile Num</b></label>
    <input type="text" placeholder="Enter Mobile Num" name="Phone" required>
    
    <label for="email"><b>Email</b></label>
    <input type="text" placeholder="Enter Email" name="email" required>
    
    <label for="ss"><b>Social Security</b></label>
    <input type="text" placeholder="Enter Social Security num" name="ss" required>
...
async function upload(){
  ...
  let account = "0xC4D5096C122fDb178EC1542BD701878171193BD7";

  //get file data from file upload input field
  let file = document.getElementById('gh').files[0];
  ...
  reader.onload = async function(e) {
    ...
    let link = filestorage.uploadFile(address, filePath, fileBuffer);
  };
...
async function getFiles(){
  ...
  async function deleteFile(fileName) {
    ...
    await filestorage.deleteFile(account, fileName);
